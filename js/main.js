...
// -------------------------------------------
// -------------------------------------------
// Transformer le code en programmation objet.
// -------------------------------------------
// -------------------------------------------
...
function GiTooltip(){
  ...
  // methode privée (var) car pas besoin d'y faire appel spécifiquement depuis l'exterieur
  ...
  var getTooltipTargets = function(attribute) {
  ...
  var createTooltipDom = function(e){
  ...
  var positionTooltipDom = function(e, tooltipContainer){
  ...
  var addTooltipListener = function(targets){
